...
// kb_ack            键盘_确认
// kb_init           键盘_初始化
// kb_init_once      键盘_初始化_一次
// kbd_loadmap   键盘驱动_加载映射？
// do_fkey_ctl         做_f键_控制
// func_key          函数_键
// show_key_mappings 显示_键_映射s
// scan_keyboard     扫描_键盘
// do_panic_dumps      做_恐慌_转存
